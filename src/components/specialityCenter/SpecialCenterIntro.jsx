  ...
  return (
    <>
      <div className="pt_adjustment mx-5 sm:mx-16 md:mx-24">
        ...
        <div className="paragraph pt-2 sm:pt-3">
          <h5 data-aos="fade-down" className="pb-2 text-base font-semibold">
            Centres of Excellence
          </h5>
          <p data-aos="fade-down" className="mb-2 text-xs sm:text-base">
            ...
            technologies in its respective field. Concerted effort has been put
            in to ensure patients' comfort, privacy, and treatments are not
            compromised. The perfect marriage of medical technologies and the
            experts' hands ensures our best practices.
          </p>
          <ul data-aos="fade-right" data-aos-offset="200" className=" my-5">
