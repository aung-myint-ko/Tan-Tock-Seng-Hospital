  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 overflow-hidden">
      <div
        ...
        className="intro_left_box mt-8 mx-5 md:mt-16 md:ml-16 md:mr-4 lg:mt-16 lg:ml-24 lg:mr-4 "
      >
        ...
        <p className="mb-3 text-sm lg:text-base">
          ...
          well-equipped with modern technology. It is located on No.68, Taw Win
          Road, 9 Mile, Mayagone Township, Yangon, Myanmar. Victoria Hospital
          offers comprehensive medical services with superior quality and high
          efficiency.
        </p>
        <div>
          <button
            ...
            data-aos-delay="500"
            className="button2 w-28 h-10 text-base md:w-24 md:h-8 lg:w-28 lg:h-9 md:text-sm lg:text-base"
          >
            Learn More
          </button>
        </div>
      ...
      <div
        data-aos="fade-left"
        data-aos-duration="1000"
        className="intro_right_box mt-8 mx-5 md:mt-16 md:ml-4 md:mr-16 lg:mt-16 lg:ml-4 lg:mr-24"
      >
